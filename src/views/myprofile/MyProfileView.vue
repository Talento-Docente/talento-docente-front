...
export default defineComponent({
  ...
  data() {
    return {
      // TEST
      link: "https://martinvallefotografos.net/wp-content/uploads/2018/12/FOTOGRAFIA-CURRICULUM-ASTURIAS-MARTIN-VALLE-FOTOGRAFOS-01.jpg",
      authStore: authStore(),
  ...
  methods: {
    toPostulation() {
      this.$router.push({ name: "Postulation" });
    },
  }
